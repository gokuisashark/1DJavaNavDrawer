...
public class WeekViewEvent {
     ...
     */
    public WeekViewEvent(int id, String name, int startYear, int startMonth, int startDay, int startHour, int startMinute, int endYear, int endMonth, int endDay, int endHour, int endMinute) {
        this.mId = id;
     ...
     * @param endTime The time when the event ends.
     */
    public WeekViewEvent(int id, String name, String location, Calendar startTime, Calendar endTime) {
