...
//            UserInformation uInfo = new UserInformation();
            ...
            for (HashMap<String, String> map : (ArrayList<HashMap<String, String>>) ds.getValue()) {
                ...
                timetable_list.add(index + 0, map.get("year"));
                timetable_list.add(index + 1, map.get("month"));
                timetable_list.add(index + 2, map.get("day"));
                timetable_list.add(index + 3, map.get("start_hour"));
                timetable_list.add(index + 4, map.get("start_minute"));
                timetable_list.add(index + 5, map.get("end_hour"));
                timetable_list.add(index + 6, map.get("end_minute"));
                timetable_list.add(index + 7, map.get("name"));
            ...
            case R.id.add_event:
                ...
                put_the_event.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(BasicActivity.this, "Event is added successfully", Toast.LENGTH_SHORT).show();
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(BasicActivity.this, BasicActivity.this,
                                year, month, day);
...
//        add_startingtime.setVisibility(View.VISIBLE);
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(BasicActivity.this, BasicActivity.this,
...
//            add_endingtime.setVisibility(View.VISIBLE);
            ...
            TimePickerDialog timePickerDialog1 = new TimePickerDialog(BasicActivity.this, BasicActivity.this,
                    hour, minute, DateFormat.is24HourFormat(this));
...
//                String userID = user.getUid();
                myRef.child("timetable").child(Integer.toString(count)).child("year").setValue(yearFinal);
                myRef.child("timetable").child(Integer.toString(count)).child("month").setValue((monthFinal - yearFinal));
                myRef.child("timetable").child(Integer.toString(count)).child("day").setValue(dayFinal);
                myRef.child("timetable").child(Integer.toString(count)).child("start_hour").setValue(hourFinal);
                myRef.child("timetable").child(Integer.toString(count)).child("start_minute").setValue(minuteFinal);
                myRef.child("timetable").child(Integer.toString(count)).child("end_hour").setValue(end_hour);
                myRef.child("timetable").child(Integer.toString(count)).child("end_minute").setValue(end_minute);
                myRef.child("timetable").child(Integer.toString(count)).child("name").setValue(event_name);
...
//         Populate the week view with some events.
        ...
        System.out.println(list_of_timetable);
        String name = "";
        System.out.println("DATA: " + timetable_list);
        for(int i = 0; i < timetable_list.size(); i += 8) {
            Calendar startTime = Calendar.getInstance();

            startTime.set(Calendar.YEAR, Integer.parseInt(String.valueOf(timetable_list.get(i))));
            startTime.set(Calendar.MONTH, Integer.parseInt(String.valueOf(timetable_list.get(i + 1))));
            startTime.set(Calendar.DAY_OF_MONTH, Integer.parseInt(String.valueOf(timetable_list.get(i + 2))));
            startTime.set(Calendar.HOUR_OF_DAY, Integer.parseInt(String.valueOf(timetable_list.get(i + 3))));
            startTime.set(Calendar.MINUTE, Integer.parseInt(String.valueOf(timetable_list.get(i + 4))));

            Calendar endTime = (Calendar) startTime.clone();
            endTime.set(Calendar.HOUR_OF_DAY, Integer.parseInt(String.valueOf(timetable_list.get(i + 5))));
            endTime.set(Calendar.MINUTE, Integer.parseInt(String.valueOf(timetable_list.get(i + 6))));
            endTime.set(Calendar.MONTH, newMonth - 1);

            WeekViewEvent final_event = new WeekViewEvent(count, timetable_list.get(i+7), startTime, endTime);
